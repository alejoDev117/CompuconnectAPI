...
public final class ModificarCentroInformaticaValidation implements Validation<CentroInformaticaDTO> {

    private ModificarCentroInformaticaValidation() {
        super();
    }

    public static Result validate(final CentroInformaticaDTO data) {
        return new ModificarCentroInformaticaValidation().execute(data);
    }
