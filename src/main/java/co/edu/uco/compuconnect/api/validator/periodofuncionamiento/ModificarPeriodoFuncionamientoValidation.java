...
public final class ModificarPeriodoFuncionamientoValidation implements Validation<PeriodoFuncionamientoDTO> {

    private ModificarPeriodoFuncionamientoValidation() {
        super();
    }

    public static Result validate(final PeriodoFuncionamientoDTO data) {
        return new ModificarPeriodoFuncionamientoValidation().execute(data);
    }
