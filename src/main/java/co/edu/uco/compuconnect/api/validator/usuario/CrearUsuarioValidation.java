...
public final class CrearUsuarioValidation implements Validation<UsuarioDTO> {
    ...
    public static Result validate(final UsuarioDTO data) {
        return new CrearUsuarioValidation().execute(data);
    }
    ...
    public Result execute(final UsuarioDTO data) {
        ...
        if (UtilObject.isNull(data)) {
            result.addMessage("No es posible crear un usuario con los datos vacíos");
        } else {
